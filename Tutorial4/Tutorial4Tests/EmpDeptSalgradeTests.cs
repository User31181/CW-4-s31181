...
public class EmpDeptSalgradeTests
{
    ...
    public void ShouldJoinEmployeesWithDepartments()
    {
        ...
        var result = emps
            .Join(depts, e => e.DeptNo, d => d.DeptNo, (emp, dept) => new {emp.EName, dept.DName} )
            .ToList(); 
    ...
    public void ShouldMatchEmployeeToSalaryGrade()
    {
        ...
        var result = emps
            .Join(grades, e => true, g => true, (emp, grades) => new {emp.EName, grades.Grade,emp.Sal, grades.Losal,grades.Hisal})
            .Where(e=> e.Sal<=e.Hisal && e.Sal >= e.Losal)
    ...
    public void ShouldReturnEmployeesEarningMoreThanDeptAverage()
    {
        ...
        var result = emps
            .Where(a => a.Sal >
                        emps.Where(b => a.DeptNo == b.DeptNo)
                            .Average(b=>b.Sal))
            .Select(a=>a.EName)
            .ToList();
