...
public class AdvancedEmpDeptTests
{
    ...
    public void ShouldReturnEmployeeManagerPairs()
    {
        ...
        var result = emps
            .Join(emps, a=> a.Mgr, b=>b.EmpNo, (a, b) => new {Employee = a.EName, Manager = b.EName})
            .ToList();
    ...
    public void ShouldJoinEmpDeptSalgrade()
    {
        ...
        var result = emps
            .Join(depts, e => e.DeptNo, d => d.DeptNo, (emp, dept) => new {emp.EName, dept.DName, emp.Sal})
            .Join(grades, e=> true, b=>true, (empDepts, grade) => 
                new {empDepts.EName, empDepts.DName, grade.Grade, empDepts.Sal, grade.Losal, grade.Hisal})
